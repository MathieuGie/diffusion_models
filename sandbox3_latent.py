...
class MLP(pl.LightningModule):
    def __init__(self):
        ...
        self.linear1 = nn.Linear(385, 600)
        self.linear2 = nn.Linear(600, 450)
        #self.linear3 = nn.Linear(500, 500)
        self.linear4 = nn.Linear(450, latent_size)
    ...
    def on_train_epoch_start(self):
        ...
        with torch.no_grad():
            ...
            image = torch.rand((latent_size,1)).to(mps_device)
            step=1
            i=0
...
class DenoisingDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        more_noisy_image = torch.load(more_noisy_img_path).view(1, latent_size)
        less_noisy_image = torch.load(less_noisy_img_path).view(1, latent_size)

        step_tensor = torch.zeros((1,1)) 
        step_tensor[0,0]=step

        #print(more_noisy_image.shape)
...
dir_images = '/Users/mathieugierski/Nextcloud/Macbook M3/Diffusion/CAT_00_latent_noisy/step_0'
dir_all =  '/Users/mathieugierski/Nextcloud/Macbook M3/Diffusion/CAT_00_latent_noisy'
